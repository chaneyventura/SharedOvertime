...
describe 'navigate' do
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: "Employee", last_name: "Authorized", email: "employee@test.com", password: "password", password_confirmation: "password", phone: '555555555')
